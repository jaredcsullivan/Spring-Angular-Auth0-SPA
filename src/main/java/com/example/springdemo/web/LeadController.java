...
import com.example.springdemo.service.UsernameService;
...
final class LeadController {
    ...
    @Autowired
    LeadController(LeadService service, UsernameService usernameService) {
    ...
    LeadDTO create(@RequestBody @Valid LeadDTO leadEntry) {
    	
        String reqUser = usernameService.getUsername();
    ...
    List<LeadDTO> findByUsername() {

        String reqUser = usernameService.getUsername();

    	LOGGER.info("Current user accessed secured resource: " + reqUser);
